...
func (lsServer *LsServer) Listen(didListen func(listenAddr *net.TCPAddr)) error {
	return myproxy.ListenEncryptedTCP(lsServer.ListenAddr, lsServer.Cipher, lsServer.handleConn, didListen)
}

func (lsServer *LsServer) handleConn(localConn *myproxy.SecureTCPConn) {
